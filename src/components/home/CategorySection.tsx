    ...
    <section className="py-16 bg-agro-lightgray">
      <div className="container mx-auto px-4">
        ...
        <p className="text-lg text-gray-600 mb-8">
          Browse our extensive range of high-quality spare parts
        </p>
