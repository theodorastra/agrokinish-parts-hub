        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center text-agro-darkgray">
              Why Choose Agrokinish Strapatsas
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600">
                  All our spare parts are sourced from trusted manufacturers and undergo rigorous quality checks.
                </p>
              </div>
              ...
              <div className="text-center p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600">
                  Efficient shipping process ensures your spare parts arrive on time, minimizing downtime.
                </p>
              </div>
              ...
              <div className="text-center p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600">
                  Our knowledgeable team provides technical assistance to help find the right parts for your needs.
                </p>
              </div>
            </div>
          </div>
